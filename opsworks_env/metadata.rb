...
recipe "opsworks_env::deploy", "Write a config/application.yml file to app's deploy directory. Relies on restart command declared by rails::configure recipe. (Intended as part of deploy OpsWorks events.)"
